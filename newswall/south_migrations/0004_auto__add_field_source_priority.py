...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newswall_source', 'priority', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.priority'
        db.delete_column('newswall_source', 'priority')
